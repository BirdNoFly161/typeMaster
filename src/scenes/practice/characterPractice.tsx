    ...
    return (
        <div className="h-[calc(100vh-3rem)] flex flex-col justify-between items-center p-12 bg-primary-light">
            <div className="flex flex-col justify-stretch items-center gap-3">
                <span className="flex justify-center rounded-2xl text-3xl w-full">
                    Welcome to character practice !
                </span>
                <div className="flex gap-2">
                    <span className="bg-secondary p-6 border border-primary rounded-2xl text-3xl">
                        Generated char: {generatedChar}
                    </span>
                </div>
                <span className='bg-secondary p-6 border border-primary rounded-2xl text-3xl'>Score: {correct}/{total}</span>
            </div>
